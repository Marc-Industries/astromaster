...
export const QuizCard = ({ question, onAnswer, isLastQuestion }) => {
            ...
            return html`
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <span>${option}</span>
                  ${isRevealed && index === question.correctAnswerIndex && html`
                    <${CheckCircleIcon} className="w-6 h-6 text-green-500 ml-auto flex-shrink-0" />
                  `}
                  ${isRevealed && index === selectedOption && index !== question.correctAnswerIndex && html`
